...
def run_etf_backtest():
    print("=" * 100)
    print("ETF MACD Strategy Backtest")
    ...
    print(f"Positive return ETFs: {win_count} ({win_count/total_count*100:.1f}%)")
    ...
    report_file = output_dir / f"etf_macd_{timestamp}.json"
    ...
    data = {
        ...
        'summary': {
            ...
            'winning_etfs': win_count,
            'win_rate_etfs': win_count / total_count * 100,
