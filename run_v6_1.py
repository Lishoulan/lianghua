...
def run_backtest(stock_limit=300):
    print("=" * 120)
    print("v6.1: Universe AMV + EMA-5周线 + 季度滚动训练 + 动态成本阀门")
    print("=" * 120)
    print(f"\nConfig:")
    ...
    print("\n" + "=" * 120)
    print("v6.1 WALK-FORWARD RESULTS")
    print("=" * 120)
    ...
    data = {
        'strategy': 'v6.1_universe_amv_ema5_quarterly_wf',
        'config': {
    ...
    report_file = output_dir / f"v6.1_{timestamp}.json"
